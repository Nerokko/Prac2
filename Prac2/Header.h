...
// ласс лекарства, все пол€ открыты
public class Medicine {
public:
	unsigned int id{}; // id лекарства
	unsigned int quantity{}; // количество  
	unsigned int price{}; // цена  
	std::string name{}; // айди
	std::string maker{}; // компани€
	std::string category{}; // направление
	std::string form{}; // им€
};
...
void read_medicines_from_txt(Medicine* medicines, int& last, int &index);
