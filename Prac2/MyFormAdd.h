...
namespace Prac2 {
	...
	/// <summary>
	/// Сводка для MyFormAdd
	/// </summary>
	public ref class MyFormAdd : public System::Windows::Forms::Form
	{
	public:
		Medicine* medicines;
		int* index;
	...
	public:
		...
		MyFormAdd(Medicine* medicines, int* last, int *index, System::Windows::Forms::DataGridView^ dataGridView1)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormAdd::typeid));
			...
			this->label1->Text = L"Айди";
			this->label1->Click += gcnew System::EventHandler(this, &MyFormAdd::label1_Click);
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(25, 83);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(171, 26);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Компания";
			// 
			// label3
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(25, 191);
			this->label4->Name = L"label4";
			this->label4->Size = System::Drawing::Size(117, 26);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Направление";
			this->label4->Click += gcnew System::EventHandler(this, &MyFormAdd::label4_Click);
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label5->Location = System::Drawing::Point(25, 241);
			...
			this->label6->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 16.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label6->Location = System::Drawing::Point(25, 297);
			...
			this->numericUpDownCount->Location = System::Drawing::Point(272, 138);
			...
			this->numericUpDownCount->Size = System::Drawing::Size(124, 26);
			...
			this->numericUpDownPrice->Location = System::Drawing::Point(272, 297);
			...
			this->numericUpDownPrice->Size = System::Drawing::Size(123, 26);
			...
			this->textBoxName->Location = System::Drawing::Point(272, 31);
			this->textBoxName->Name = L"textBoxName";
			this->textBoxName->Size = System::Drawing::Size(124, 26);
			this->textBoxName->TabIndex = 8;
			this->textBoxName->TextChanged += gcnew System::EventHandler(this, &MyFormAdd::textBox1_TextChanged);
			// 
			// textBoxMaker
			// 
			this->textBoxMaker->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
			this->textBoxMaker->Location = System::Drawing::Point(272, 84);
			this->textBoxMaker->Name = L"textBoxMaker";
			this->textBoxMaker->Size = System::Drawing::Size(124, 26);
			...
			this->buttonOk->Location = System::Drawing::Point(272, 360);
			this->buttonOk->Name = L"buttonOk";
			this->buttonOk->Size = System::Drawing::Size(124, 36);
			this->buttonOk->TabIndex = 12;
			this->buttonOk->Text = L"Готово";
			this->buttonOk->UseVisualStyleBackColor = false;
			this->buttonOk->Click += gcnew System::EventHandler(this, &MyFormAdd::buttonOk_Click);
			// 
			// comboBoxForm
			// 
			this->comboBoxForm->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
			this->comboBoxForm->FormattingEnabled = true;
			this->comboBoxForm->Items->AddRange(gcnew cli::array< System::Object^  >(5) { L"Влад", L"Дима", L"Кира", L"Стив", L"Леона"});
			this->comboBoxForm->Location = System::Drawing::Point(272, 241);
			this->comboBoxForm->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->comboBoxForm->Name = L"comboBoxForm";
			this->comboBoxForm->Size = System::Drawing::Size(124, 28);
			...
			this->comboBoxCategory->Items->AddRange(gcnew cli::array< System::Object^  >(5) {
				L"Мск->Спб", L"Спб->Мск", L"Спб->Калининград",
					L"Калининград->Спб", L"Калининград->Мск"
			});
			this->comboBoxCategory->Location = System::Drawing::Point(271, 193);
			...
			this->ClientSize = System::Drawing::Size(425, 432);
...
public: System::Void buttonOk_Click(System::Object^ sender, System::EventArgs^ e){
	...
	if (medicines[*last].name.length() == 0) medicines[*last].name = "Айди";
	if (medicines[*last].maker.length() == 0) medicines[*last].maker = "Компания";
	if (medicines[*last].category.length() == 0) medicines[*last].category = "Направление";
	if (medicines[*last].form.length() == 0) medicines[*last].form = "Имя";
